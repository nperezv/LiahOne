...
export const insertSacramentalMeetingSchema = createInsertSchema(sacramentalMeetings, {
  ...
  aaronicOrderings: z.array(z.union([z.string(), z.object({ name: z.string(), office: z.string() })])).optional(),
  aaronicAdvancements: z.array(z.object({ name: z.string(), office: z.string() })).optional(),
