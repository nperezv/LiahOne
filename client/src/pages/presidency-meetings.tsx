  ...
  return (
    <div className="space-y-6 p-4 md:space-y-8 md:p-6 xl:p-8">
      ...
      <div className="mt-3 grid grid-cols-2 gap-3 md:gap-4 lg:hidden">
        <div
          className="col-span-1 flex min-h-[220px] flex-col rounded-3xl border border-border/70 p-4 text-left"
        ...
        <div className="col-span-1 grid gap-3 md:gap-4">
          <button
            ...
            className="rounded-3xl border border-border/70 p-4 text-left transition-colors hover:bg-card"
      ...
      <div className="grid grid-cols-2 gap-3 md:gap-4 lg:hidden">
        <div className="col-span-1 flex flex-col gap-3 md:gap-4">
          <Dialog open={membersDialogOpen} onOpenChange={setMembersDialogOpen}>
            <button type="button" onClick={() => setMembersDialogOpen(true)} className="rounded-3xl border border-border/70 p-4 text-left transition-colors hover:bg-card" data-testid="button-org-members-card">
          ...
          <button type="button" onClick={() => setLocation(`/calendar?org=${params?.org ?? ""}`)} className="rounded-3xl border border-border/70 p-4 text-left transition-colors hover:bg-card" data-testid="button-org-calendar-card">
        ...
        <button
          type="button"
          onClick={() => navigateWithTransition(setLocation, `/presidency/${params?.org ?? ""}/manage`)}
          className="col-span-1 flex h-full min-h-[220px] flex-col justify-between overflow-hidden rounded-3xl border border-border/70 p-4 text-left transition-colors hover:bg-card"
      ...
      <div className="hidden gap-3 md:gap-4 lg:grid lg:grid-cols-12">
        <Dialog open={leadersDialogOpen} onOpenChange={setLeadersDialogOpen}>
          <div
            className="flex min-h-[220px] flex-col rounded-3xl border border-border/70 p-4 text-left lg:col-span-6 lg:min-h-[260px]"
        ...
        <div className="col-span-1 flex flex-col gap-3 md:gap-4 lg:col-span-6 lg:flex lg:flex-col">
          <button type="button" onClick={() => setMembersDialogOpen(true)} className="rounded-3xl border border-border/70 p-4 text-left transition-colors hover:bg-card" data-testid="button-org-members-card-desktop">
            <p className="text-xs text-muted-foreground">Miembros de la organización</p>
            <div className="mt-2 flex items-center justify-between">
              <p className="text-2xl font-semibold md:text-3xl">{dashboardStats.membersCount}</p>
              <Users className="h-5 w-5 text-muted-foreground" />
          ...
          <button type="button" onClick={() => setLocation(`/calendar?org=${params?.org ?? ""}`)} className="rounded-3xl border border-border/70 p-4 text-left transition-colors hover:bg-card" data-testid="button-org-calendar-card-desktop">
            <p className="text-xs text-muted-foreground">Calendario</p>
            <div className="mt-2 flex items-center justify-between">
              <p className="text-2xl font-semibold md:text-3xl">{dashboardStats.monthlyActivities}</p>
              <CalendarDays className="h-5 w-5 text-muted-foreground" />
        ...
        <button
          type="button"
          onClick={() => navigateWithTransition(setLocation, `/presidency/${params?.org ?? ""}/manage`)}
          className="col-span-1 flex h-full min-h-[220px] flex-col justify-between overflow-hidden rounded-3xl border border-border/70 p-4 text-left transition-colors hover:bg-card lg:col-span-6"
