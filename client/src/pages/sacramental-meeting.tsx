  ...
  return (
    <div className="relative">
      ...
      {open && value.trim().length > 0 && filtered.length > 0 && (
        <ul className="absolute z-[100] left-0 right-0 top-full mt-1 max-h-52 overflow-y-auto rounded-lg border border-border bg-popover shadow-lg text-sm">
...
const MemberAutocomplete = ({
  ...
  return (
    <div className="relative">
      ...
      />
      {open && value.trim().length > 0 && filtered.length > 0 && (
        <ul className="absolute z-[100] left-0 right-0 top-full mt-1 max-h-48 overflow-y-auto rounded-lg border border-border bg-popover shadow-lg text-sm">
...
function SacramentalMeetingPageInner() {
  ...
  const callingsByOrgType: Record<string, string[]> = {
    ...
    "cuorum_elderes": ["Presidente", "Primer consejero", "Segundo consejero", "Secretario", "Maestro", "Líder de ministración", "Líder de actividades", "Coordinador de tecnología de organización"],
    "sociedad_socorro": ["Presidenta", "Primera consejera", "Segunda consejera", "Secretaria", "Maestra", "Coordinadora de ministración", "Líder de actividades", "Coordinadora de tecnología de organización"],
    "mujeres_jovenes": ["Presidenta", "Primera consejera", "Segunda consejera", "Secretaria", "Asesora de clases", "Especialistas de Mujeres Jóvenes", "Líder de actividades", "Coordinadora de tecnología de organización"],
    "hombres_jovenes": ["Presidente del Sacerdocio Aarónico", "Primer consejero del Sacerdocio Aarónico", "Segundo consejero del Sacerdocio Aarónico", "Asesor de Hombres Jóvenes", "Especialista de Hombres Jóvenes", "Presidente de quórum de diáconos", "Primer consejero de quórum de diáconos", "Segundo consejero de quórum de diáconos", "Secretario de quórum de diáconos", "Presidente de quórum de maestros", "Primer consejero de quórum de maestros", "Segundo consejero de quórum de maestros", "Secretario de quórum de maestros", "Presidente de quórum de presbíteros", "Primer ayudante de quórum de presbíteros", "Segundo ayudante de quórum de presbíteros", "Líder de actividades", "Coordinador de tecnología de organización"],
    "primaria": ["Presidenta", "Primera consejera", "Segunda consejera", "Secretaria", "Líder de música", "Pianista", "Maestro", "Maestra", "Líder de guardería", "Líder de actividades", "Coordinadora de tecnología de organización"],
    "escuela_dominical": ["Presidente", "Presidenta", "Primer consejero", "Primera consejera", "Segundo consejero", "Segunda consejera", "Secretario", "Secretaria", "Maestro", "Maestra", "Líder de actividades", "Coordinador de tecnología de organización", "Coordinadora de tecnología de organización"],
    "jas": ["Líder", "Líder de actividades", "Coordinador de tecnología de organización"],
  ...
  return (
    ...
    <div className="relative flex min-h-full overflow-hidden">
      ...
      <Dialog open={isPanelOpen} onOpenChange={(open) => !open && closePanel()}>
        <DialogContent className="max-w-3xl h-[85vh] max-h-[780px] p-0 flex flex-col overflow-hidden sm:rounded-2xl border border-border/60 shadow-2xl">
          <Form {...form}>
            <form onSubmit={(e) => { e.preventDefault(); onSubmit(form.getValues()); }} className="flex h-full min-h-0 flex-1 flex-col">
                ...
                {tabs.map((tab, i) => {
                  ...
                  return (
                    <button
                      ...
                      className={cn(
                        "flex items-center gap-1.5 px-3 py-2.5 text-xs font-semibold whitespace-nowrap transition-all border-b-2 -mb-[2px] shrink-0",
                        isCurrent
              ...
              <div className="flex-1 overflow-y-auto px-4 md:px-6 py-5 min-h-0 space-y-6">
                {/* ── TAB 1: General ── */}
                {activeTab === "general" && (
