      ...
      {activeSection === "resumen" && isObispado && (
        <>
          <Card className="mb-5">
            <CardContent className="p-6 pb-5">
              ...
              <div className="mt-7 grid grid-cols-4 gap-3">
                {[1, 2, 3, 4].map((quarter) => (
                  <div key={quarter} className="rounded-xl bg-white/5 px-2 py-2">
                    <p className="mb-1 text-[9px] font-bold uppercase tracking-[0.1em] text-slate-500">T{quarter}</p>
                    <p className={`text-center text-[12px] font-extrabold leading-tight md:text-[14px] ${quarter === currentQuarter ? "text-violet-400" : "text-slate-100"}`}>€{quarterBudgets[quarter as 1 | 2 | 3 | 4].toFixed(2)}</p>
                  </div>
                ))}
              </div>
            </CardContent>
          ...
          <div className="mb-5 grid grid-cols-3 gap-3">
            <Card>
              <CardContent className="px-[14px] py-4">
                <p className="mb-1.5 text-[9px] font-bold uppercase tracking-[0.1em] text-slate-500">Trimestre actual</p>
                <p className="text-center text-[18px] font-extrabold leading-none text-slate-100 md:text-[20px]" data-testid="text-ward-budget-quarter">€{globalBudget.toFixed(2)}</p>
